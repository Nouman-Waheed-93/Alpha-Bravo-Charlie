...
namespace UnityStandardAssets.Cameras
{
    public class CameraClipping : MonoBehaviour
    {
        ...
        private HeadCameraWeapon hcw;


        private void Start()
        {
            // find the camera in the object hierarchy
            hcw = GetComponent<HeadCameraWeapon>();
            m_Pivot = transform.parent;
            m_OriginalDist = hcw.DefaultDistance;
        ...
        private void LateUpdate()
        {
            ...
            m_CurrentDist = Mathf.Clamp(m_CurrentDist, closestDistance, m_OriginalDist);
          	hcw.Distance = m_CurrentDist ;
			//hcw.Distance = m_CurrentDist- 1f;
